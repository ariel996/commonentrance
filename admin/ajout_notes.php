            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading main-color-bg">
                        <h3 class="panel-title"> NEW TEST PAPER NOTE<a href="welcome_admin.php" style="float: right"><span class="fa fa-home"></span> </a></h3>
                    </div>

                    <!-- le contenu de la box -->
                    <div class="panel-body">
                        <div class="alert alert-info" id="show">
                            <a href="#" class="close" data-dismiss="alert">&times;</a>
                            <strong>Insertion of student note</strong>
                        </div>
                        <form id="resultats">
                            <div class="col-md-4">
                               <!--<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="search" id="search" class="form-control" placeholder="enter the code of a student">
                                </div>

                                <div class="form-group">
                                    <label>Note /20</label>
                                    <input type="text" name="note" id="note" class="form-control" placeholder="15/20" required>
                                </div>

                                <div class="form-group">
                                    <button type="button" class="btn btn-primary btn-block" id="sauver" name="sauver">Save</button>
                                </div>
                            </div>
                        </form>
...
<script>
    $(document).ready(function () {
        $("#sauver").on('click', function () {
            var formData = $("#resultats").serialize();
            $.ajax({
                url: 'addNotes.php',
                type: 'POST',
                data: formData,
                success: function (data) {
                    $('#show').removeClass('alert-info');
                    $('strong').attr('Data successfully added !!');
