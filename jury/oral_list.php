        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="oral_list.php" class="list-group-item active">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading main-color-bg">
                        <h3 class="panel-title"> ORAL RESULT LIST <a href="welcome_jury.php" style="float: right"><span class="fa fa-home"></span> </a></h3>
                    </div>

                    <!-- le contenu de la box -->
                    <div class="panel-body">
                        <form id="resultats" action="search_oral.php" method="post">
...
<script>
    ...
    $("#imprimer").on('click', function () {
        window.open('list_oral.php','_blank');
    });
