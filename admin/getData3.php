...
$sql = mysql_query("SELECT nomCandidat,dateNaiss,lieuNaiss,nomFiliere,telephone FROM candidate,filiere WHERE filiere.nomFiliere='$filiere' AND candidate.cycle='FIRST YEAR SECOND CYCLE'");
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <button type="button" class="btn btn-primary" name="printing" id="printing3"><span class="fa fa-print"> Print List</span> </button>
                                </div>
                            </div>
                        </div>
                    </div>
