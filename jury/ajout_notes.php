            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading main-color-bg">
                        <h3 class="panel-title"> NEW TEST PAPER NOTE<a href="welcome_teacher.php" style="float: right"><span class="fa fa-home"></span> </a></h3>
                    </div>
                            ...
                            <div class="col-md-4">
                               <!--<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="search" id="search" class="form-control" placeholder="enter the code of a student" required>
                                </div>

                                <div class="form-group">
                                    <label>Note </label>
                                    <div class="input-group">
                                        <input type="text" name="note" id="note" class="form-control" placeholder="15" required>
