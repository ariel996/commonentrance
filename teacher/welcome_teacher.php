        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    <a href="welcome_teacher.php" class="list-group-item active main-color-bg">
                    ...
                    <a href="note.php" class="list-group-item">
                        <span class="fa fa-sticky-note"></span> NOTES
                    </a>
                        ...
                        <div class="col-md-3">
                            <div class="well dash-box">
                                <h2><span class="glyphicon glyphicon-user" aria-hidden="true"></span> <?php
                                    $sql = "SELECT formCandidate FROM  candidate WHERE cycle='FIRST YEAR FIRST CYCLE'";
                                    $run = mysql_query($sql);
                                    echo mysql_num_rows($run);
                                    ?></h2>
                                <h4>First Year First Cycle</h4>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="well dash-box">
                                <h2><span class="glyphicon glyphicon-user" aria-hidden="true"> </span> <?php
                                    $sql = "SELECT formCandidate FROM  candidate WHERE cycle='THIRD YEAR FIRST CYCLE'";
                                    $run = mysql_query($sql);
                                    echo  mysql_num_rows($run);
                                    ?></h2>
                                <h4>Third Year First Cycle</h4>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="well dash-box">
                                <h2><span class="glyphicon glyphicon-user" aria-hidden="true"></span> <?php
                                    $sql = "SELECT formCandidate FROM  candidate WHERE cycle='FIRST YEAR SECOND CYCLE'";
                                    $run = mysql_query($sql);
                                    echo  mysql_num_rows($run);
                                    ?></h2>
                                <h4>First Year Second Cycle</h4>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="well dash-box">
                                <h2><span class="glyphicon glyphicon-signal" aria-hidden="true"></span> <?php
                                    $sql = "SELECT formCandidate FROM  candidate";
                                    $run = mysql_query($sql);
                                    echo  mysql_num_rows($run);
                                    ?></h2>
                                <h4>Candidate(s) registered</h4>
                            </div>
                        </div>
                    </div>
                </div>
