...
?>
    ...
    <section id="breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                <li><span class="fa fa-home"><a href="welcome_admin.php"> Admin Area</a> </span></li>
                ...
                <div class="col-md-9">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form id="monForm" method="post" action="field2.php">
                                <div class="col-md-4">
...
if(isset($_POST['filiere'])){
    echo "<script>window.open('getData2.php','_self')</script>";
