        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="note.php" class="list-group-item active">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading main-color-bg">
                        <h3 class="panel-title"> NOTES <a href="welcome_admin.php" style="float: right"><span class="fa fa-home"></span> </a></h3>
                    </div>
                        ...
                        <form id="resultats" action="search_notes.php" method="post">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <button type="button" class="btn btn-warning btn-block" id="imprimer" name="imprimer"><span class="fa fa-print"></span> Print the list</button>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <button type="button" id="exporter" name="exporter" class="btn btn-primary btn-block"><span class="fa fa-file-excel-o"></span> Export to Excel</button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <table id="example" data-show-columns="true" data-height="460" class="ariel">
...
<script>
    ...
    $("#imprimer").on('click', function () {
        window.open('print_list_notes.php','_blank');
    });

    $("#exporter").on('click', function () {
       window.open('fichiercsv.php','_blank');
    });

    $("#importer").click(function () {
        var dons = $("#forme").serialize();
        $.ajax({
            url: 'importcsv.php',
            type: 'POST',
            data: dons,
    ...
    /*$("#check").on('click', function () {
        var epreuve = $("#redaction").val();
        $.ajax({
            url: 'search_notes.php',
            type: 'POST',
            data: epreuve,
            success: function(data) {
                $("#nosDonnees").html(data);
            }
        });
    });*/
