        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="writing_results.php" class="list-group-item active">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading main-color-bg">
                        <h3 class="panel-title">WRITING RESULTS</h3>
                    </div>
                    <div class="panel-body">
                        <div class="well" id="well">
                            Take care for your criteria
                        </div>
...
<script>
    $(document).ready(function() {
        $("#valid").on('click', function () {
            ...
            var mesValeurs = $("#resultForm").serialize();
            $.ajax({
