                    ...
                    <div class="panel-body">
                        <div class="col-md-8">
                            <div class="alert alert-info" id="msg">
                                ...
                                <strong>Info !</strong> Page to add new Jury
                            </div>
                            <form method="post" id="juryForm">

                                <div class="form-group">
                                    <label>Jury code</label>
                                    <input type="text" class="form-control" name="jurycode" id="jurycode" placeholder="Jury Code" required>
                                </div>

                                <div class="form-group">
                                    <label>Jury Name</label>
                                    <input type="text" name="juryName" id="juryName" class="form-control" placeholder="Jury Name" required>
                                </div>
                                ...
                                <div class="form-group form-inline">
                                    <button class="btn btn-primary" id="register" type="submit">ADD JURY</button>
...
<script>
    $(document).ready(function () {
        $("#register").on('click', function () {
            var donnees = $("#juryForm").serialize();
