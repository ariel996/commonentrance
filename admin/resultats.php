        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="resultats.php" class="list-group-item active">
                        <span class="fa fa-database"></span> ORAL RESULTS
                    </a>
                    <a href="resultats.php" class="list-group-item active">
                        <span class="fa fa-database"></span> WRITING RESULTS
                    </a>
                    <a href="resultats.php" class="list-group-item active">
                        <span class="fa fa-database"></span> ORAL RESULTS LIST
                    </a>
                    <a href="resultats.php" class="list-group-item active">
                        <span class="fa fa-database"></span> WRITING RESULTS LIST
                    </a>
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading main-color-bg">
                        <h3 class="panel-title"> MANAGE RESULTS <a href="welcome_admin.php" style="float: right"><span class="fa fa-home"></span> </a></h3>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#ok").on('click', function () {
            var donnees = $("#monForm").serialize();
           //var monForm = $("#monForm").serialize();
           $.ajax({
        ...
        $("#abandon").click(function () {
            window.open('welcome_admin.php','_self');
        })
    });
</script>
</body>
