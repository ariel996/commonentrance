...
$sql = mysql_query("SELECT nomCandidat,dateNaiss,lieuNaiss,nomFiliere,telephone FROM candidate,filiere WHERE candidate.cycle='FIRST YEAR FIRST CYCLE' AND filiere.nomFiliere='$filiere'");
...
<section id="breadcrumb">
    <div class="container">
        <ol class="breadcrumb">
            <li><a href="welcome_admin.php"> <span class="fa fa-home">Admin Area</span> </a> </li>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="field1.php" class="list-group-item active">
                        <span class="glyphicon glyphicon-user"></span> FIRST YEAR FIRST CYCLE
                    </a>
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            <table  class="table table-bordered table-responsive" id="display">
                                <thead>
                                <tr>
                                    <th>Names</th>
                                    <th>Date of birth</th>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <button type="button" class="btn btn-primary" name="printing" id="printing"><span class="fa fa-print"> Print List</span> </button>
                                </div>
                            </div>
