...
// SQL Query
$sql = mysql_query("SELECT nomCandidat,dateNaiss,lieuNaiss,nomFiliere,telephone FROM candidate,filiere WHERE filiere.nomFiliere='$filiere' AND candidate.cycle='FIRST YEAR FIRST CYCLE' ORDER BY nomCandidat");
